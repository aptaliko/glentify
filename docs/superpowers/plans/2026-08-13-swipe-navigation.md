...
- [ ] **Step 4: Add the `useSwipeable` call and spread its handlers onto `<main>`**
...
- [ ] **Step 1: Confirm the build and type-check are clean**
...
- [ ] **Step 2: Code-level sanity check**
...
- [ ] **Step 3: Real-device check (best effort)**
